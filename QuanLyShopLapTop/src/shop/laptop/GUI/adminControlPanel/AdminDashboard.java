...
public class AdminDashboard extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					frame.setVisible(true);   // Hiện giao diện chính
	...
	//	setLocationRelativeTo(null); // Giữa màn hình
		...
		lblDashBoard = new JLabel("DASHBOARD - ADMIN ");
		...
		panelKH.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(desktopPane.getComponentCount() == 0) {
					QuanLyKhachHang frameKH = new QuanLyKhachHang();
		...
		panelNV.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(desktopPane.getComponentCount() == 0) {
					QuanLyNhanVien frameNV = new QuanLyNhanVien();
		...
		panelSP.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(desktopPane.getComponentCount() == 0) {
					QuanLySanPham frameSP = new QuanLySanPham();
		...
		panelLeft.add(panelHD, "cell 0 5,grow");
		...
		panelLogout.setBackground(Color.DARK_GRAY);
		panelLeft.add(panelLogout, "cell 0 6,grow");
